...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/monkey01127/vuemonkey-element-admin.git')).toBe(true)
    expect(validURL('http://github.com/monkey01127/vuemonkey-element-admin.git')).toBe(true)
    expect(validURL('github.com/monkey01127/vuemonkey-element-admin.git')).toBe(false)
  })
  it('validLowerCase', () => {
